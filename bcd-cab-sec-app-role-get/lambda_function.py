...
def lambda_handler(event, context):
    ...
    msg = {}
    records = []
    sql = "SELECT app_id,role_id,role_name, last_updated FROM sec_app_role WHERE role_id = :role_id"
    parameter = {'name':'role_id','value':{'longValue':event['role_id']}}
    ...
    for record in response['records']:
        ...
        parm['role_id'] = record[1]['longValue']
        parm['role_name'] = record[2]['stringValue']

...
def lambda_handler(event, context):
   ...
   #config = {}
    ...
    sql = "INSERT INTO sec_app (app_name,organization,last_updated) VALUES(:app_name,:organization,CURRENT_TIMESTAMP)"
    parameter = [
                    {'name':'app_name','value':{'stringValue':event['app_name']}},
                    {'name':'organization','value':{'stringValue':event['organization']}},

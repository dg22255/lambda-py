...
def lambda_handler(event, context):
    ...
    sql = "INSERT INTO sec_user (email,first_nme,last_nme,pw,is_active,is_verified,last_updated) VALUES(:email,:first_nme,:last_nme,:pw,FALSE,FALSE,CURRENT_TIMESTAMP)"
    parameter = [
                    {'name':'email','value':{'stringValue':event['email']}},
                    {'name':'first_nme','value':{'stringValue':event['first_nme']}},
                    {'name':'last_nme','value':{'stringValue':event['last_nme']}},
                    {'name':'pw','value':{'stringValue':passwordHash}} 
                ]
